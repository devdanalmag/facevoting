        ...
        function showAlert(message, isSuccess) {
            ...
            const existingAlerts = document.querySelectorAll('.alert:not(#verification-result)');
            existingAlerts.forEach(alert => alert.remove());
            
            // Add to the current page
            const currentPage = document.querySelector('.page.active .card');
            currentPage.insertBefore(alertBox, currentPage.firstChild.nextSibling);
